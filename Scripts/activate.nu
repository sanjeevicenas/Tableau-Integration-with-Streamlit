...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SANJAY\PycharmProjects\Tableau_streamlit_integration'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SANJAY\PycharmProjects\Tableau_streamlit_integration\Scripts\deactivate.nu'
